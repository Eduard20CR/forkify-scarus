...
import { Fraction } from 'fractional/index';
...
class RecipeView extends View {
  constructor() {
    ...
    this._errorMessage = 'We could not find that recipe! Try another one! 🤦‍♂️';
    this._message =
  ...
  addHandlerServings(handler) {
    this._parentElement.addEventListener('click', function (e) {
      ...
      const btnDataSet = Number(btn.dataset.newServings);
      if (btnDataSet === 0) return;
